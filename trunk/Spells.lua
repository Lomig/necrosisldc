...
function Necrosis:SpellLocalize(tooltip) 
	...
	if not tooltip then
		self.Spell = {
			...
			[14] = {Name = GetSpellInfo(172),				Length = 18,		Type = 5}, -- Corruption
			[15] = {Name = GetSpellInfo(18708),				Length = 180,		Type = 3}, -- Fel Domination || Domination corrompue
			[16] = {Name = GetSpellInfo(603),				Length = 60,		Type = 3}, -- Bane of Doom || Plaie funeste
			...
			[22] = {Name = GetSpellInfo(980),				Length = 24,		Type = 4}, -- Bane of Agony || Plaie Agonie
			[23] = {Name = GetSpellInfo(702),				Length = 120,		Type = 4}, -- Curse of Weakness || Malédiction Faiblesse
			[25] = {Name = GetSpellInfo(1714),				Length = 30,		Type = 4}, -- Curse of Tongues || Malédiction Langage
			[26] = {Name = GetSpellInfo(1490),				Length = 300,		Type = 4}, -- Curse of the Elements || Malédiction Eléments
			...
			[44] = {Name = GetSpellInfo(18788),				Length = 60,		Type = 3}, -- Sacrifice || Sacrifice démoniaque
			...
			[58] = {Name = GetSpellInfo(54785),				Length = 45,		Type = 3}, -- Bon démoniaque
