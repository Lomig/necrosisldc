...
function Necrosis:SetMiscConfig()
	...
	if not frame then
		...
		frame:SetScript("OnEnter", function()
			...
			GameTooltip:SetText(5-frame:GetValue())
		end)
		frame:SetScript("OnLeave", function() GameTooltip:Hide() end)
		frame:SetScript("OnMouseUp", function()
			GameTooltip:SetText(5 - frame:GetValue())
			NecrosisConfig.SoulshardContainer = 4 - frame:GetValue()
			Necrosis:SoulshardSwitch("MOVE")
		end)
		frame:SetScript("OnValueChanged", function() GameTooltip:SetText(5 - frame:GetValue()) end)
		...
		frame:SetScript("OnLeave", function() GameTooltip:Hide() end)
		frame:SetScript("OnValueChanged", function() GameTooltip:SetText(frame:GetValue()) end)
		frame:SetScript("OnMouseUp", function()
			GameTooltip:SetText(frame:GetValue())
			NecrosisConfig.DestroyCount = frame:GetValue()
...
--]]
		...
		frame:SetScript("OnValueChanged", function()
			if not (frame:GetValue() == NecrosisConfig.ShadowTranceScale) then
				GameTooltip:SetText(frame:GetValue().."%")
				NecrosisConfig.ShadowTranceScale = frame:GetValue()
