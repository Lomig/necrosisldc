...
function Necrosis:Localization_Speech_Fr()
	...
	self.Speech.TP = {
		...
		[9] = {
			"<after>On parie que si 2 blaireaux cliquent sur le portail 195\167a en fait apparaitre un troisi\195\168me ?",
			"<after>Si, si, je vous jure, il s'appellera m\195\170me <target> !",
		},
		[10] = {
			"<after>Si 2 types cliquent sur le joli machin qui brille, un troisi\195\168me sortira et fera le boulot \195\160 votre place... Voici <target>, un ami qui vous veut du bien !",
			"<after><emote>rigole sous cape..."
		},
		[11] = {
			"<after>Si vous cliquez mal sur le cercle d'invocation, l'\195\162me de <target> se perdra en chemin dans les Cercles de l'Enfer, et vous ne pr\195\169f\195\169rez pas savoir ce qui peut sortir \195\160 sa place ! ",
		},
	}
	...
	self.Speech.Rez = {
		...
		[6] = {
			"<emote>fouille dans son sac, sort un vieux pot recouvert de crasse et souffle dessus pour enlever la poussi\195\168re."
			"<emote> marmonne en agitant les doigts au dessus du pot, regardant fixement <target>..."
			"<after>Bon, <target>, je viens de t'arracher l'\195\162me et de la mettre dans un bocal \195\160 anchois pour 30 minutes. Histoire qu'elle reste sur place si on meurt tous, hein ?",
		},
		[7] = {
			"LAAAAAAA MOOOOOOOOOOOOORRRRRRRRRRTTTTT.......................",
			"<after>(n'aura plus aucun effet sur <target> pendant 30 minutes...)",
		},
		[8] = {
			"<after>MPHPMMhmhmmmmpphpPOHh <target>, MMMphhhhaphhphmhhphHHahAHaApmh pierre d'\195\162me MPHmmPPPHHhhHHmu 30 minutes !",
		},
		[9] = {
			"<after>Gr\195\162ce \195\160 sa pierre d'\195\162me, <target> peut de nouveau faire n'importe quoi.",
		},
		[10] = {
			"<after><player> est prot\195\169g\195\169 par la pierre d'\195\162me pendant 30 minutes !",
			"<after>...",
			"<after>...",
			"<after>....... Non, non, je d\195\169conne, en fait c'est <target>, rassurez vous :P",
		},
	}
